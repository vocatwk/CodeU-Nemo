...
public class UserTest {
  ...
  public void testCreate() {
    ...
    Instant lastSeenNotifications = Instant.ofEpochMilli(1500);
    user.setAboutMe(aboutMe);
    user.setIsAdmin(isAdmin);
    user.setLastSeenNotifications(lastSeenNotifications);
    ...
    Assert.assertEquals(lastSeenNotifications, user.getLastSeenNotifications());
